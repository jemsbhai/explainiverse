...
from explainiverse.core.registry import ExplainerMeta, ExplainerRegistry
...
class MockExplainer(BaseExplainer):
    ...
    def explain(self, instance, **kwargs):
        ...
        return Explanation(
            ...
            explanation_data={"feature_attributions": {f"f{i}": 0.1 for i in range(n_features)}},
        )
...
def test_registry_filter_by_model_type():
    ...
    registry.register(
        "tree_only", MockExplainer, ExplainerMeta(scope="local", model_types=["tree"])
    )
    registry.register(
        "neural_only", MockExplainer, ExplainerMeta(scope="local", model_types=["neural"])
    )
    registry.register("any_model", MockExplainer, ExplainerMeta(scope="local", model_types=["any"]))
...
def test_registry_filter_by_data_type():
    ...
    registry.register(
        "tabular_exp", MockExplainer, ExplainerMeta(scope="local", data_types=["tabular"])
    )
    registry.register(
        "image_exp", MockExplainer, ExplainerMeta(scope="local", data_types=["image"])
    )
    registry.register(
        "multi_exp", MockExplainer, ExplainerMeta(scope="local", data_types=["tabular", "image"])
    )
...
def test_registry_filter_by_task_type():
    ...
    registry.register(
        "clf_only", MockExplainer, ExplainerMeta(scope="local", task_types=["classification"])
    )
    registry.register(
        "reg_only", MockExplainer, ExplainerMeta(scope="local", task_types=["regression"])
    )
    registry.register(
        "both",
        MockExplainer,
...
def test_registry_create_explainer_instance():
    ...
    explainer = registry.create("mock", model=adapter, custom_param="test_value")
...
def test_decorator_registration():
    ...
    @registry.register_decorator(
        name="decorated_mock", meta=ExplainerMeta(scope="local", model_types=["any"])
    )
...
def test_registry_list_with_details():
    ...
    registry.register("exp1", MockExplainer, ExplainerMeta(scope="local", description="First"))
    registry.register("exp2", MockExplainer, ExplainerMeta(scope="global", description="Second"))
...
def test_registry_summary():
    ...
    registry.register(
        "exp1", MockExplainer, ExplainerMeta(scope="local", description="First explainer")
    )
    registry.register(
        "exp2", MockExplainer, ExplainerMeta(scope="global", description="Second explainer")
    )
...
def test_registry_recommend():
    ...
    recommendations = registry.recommend(
        model_type="tree", data_type="tabular", scope_preference="local"
    )
