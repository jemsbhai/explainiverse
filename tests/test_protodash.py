...
"""
Integration tests for the ProtoDash objective implementation and helpers.
...
class TestCriticisms:
    ...
    def test_criticisms_sorted_by_library_score(self):
        """Rows are sorted by the library-defined kernel-witness score."""
        X, _ = make_classification(n_samples=100, n_features=5, random_state=42)
...
class TestPrototypeSummary:
    ...
    def test_summary_with_criticisms(self):
        """Combined output includes both configured result sections."""
        X, _ = make_classification(n_samples=100, n_features=5, random_state=42)
...
class TestWeightOptimization:
    ...
    def test_normalized_display_weights_sum_to_one(self):
        """Normalized presentation weights sum to one."""
        X, _ = make_classification(n_samples=100, n_features=5, random_state=42)
...
class TestEdgeCases:
    ...
    def test_reproducibility(self):
        ...
        assert (
            result1.explanation_data["prototype_indices"]
            == result2.explanation_data["prototype_indices"]
        )
...
class TestRegistryIntegration:
    ...
    def test_registry_metadata(self):
        ...
        assert meta.requires_training_data
