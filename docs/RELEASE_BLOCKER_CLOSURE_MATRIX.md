...
merge of the self-hosted-runner security boundary → final-main reruns → zero-violation B02 capture
→ authenticated B01 publisher/signing configuration and sole OIDC publication → B08 release
record and B03 downstream-only recovery. Current-main and PR #4 non-CUDA successes are valuable
direct evidence, but they cannot bypass that order or turn `a9789d0…` into the final candidate.
